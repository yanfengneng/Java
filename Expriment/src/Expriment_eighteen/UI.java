...
public class UI{
    ...
    public void AIFirstOptionInit(){
        AIFirstOption = new AbstractAction("机器人先走", new ImageIcon("image/robot.png")){
            public void actionPerformed(ActionEvent e){
    ...
    public void HumanFirstOptionInit(){
        HumanFirstOption = new AbstractAction("人类先走", new ImageIcon("image/human.png")){
            public void actionPerformed(ActionEvent e){
